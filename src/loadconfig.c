...
unsigned char getNbOfSequences(void);				// Retourne le nombre de s�quence total lue
unsigned char getNbOfCommands(void);					// Retourne le nombre de commandes total lue
unsigned char getNbOfCmdForSeq(unsigned char seqNb);	// Retourne le nombre de commandes dans une s�quence donn�e
...
unsigned char createmyMovementsTab(unsigned char seqCnt,unsigned char cmdCnt, unsigned char byteCnt){
	     ...
	     if ( myMovementsTab == NULL )
	{
	  ...
	  for (seqenceNr=0;seqenceNr<seqCnt;seqenceNr++)
	  {
		...
		// Initialisation de tous les elements de myMovementsTab � 0 ensuite remplissage de myMovementsTab et affichage
		for (seqenceNr=0;seqenceNr<seqCnt;seqenceNr++)
		  {
		      for (commandNr=0;commandNr<cmdCnt;commandNr++)
		      {
...
//------------------------------------------------------------------
// Retourne le nombre de s�quence total lue
//------------------------------------------------------------------
...
//------------------------------------------------------------------
// Retourne le nombre de commande contenue dans la s�quence donn�e
//------------------------------------------------------------------
